...
{
       public class DepartamentosEditModel : PageModel
        {
        private readonly IDepartamentosService departamentosService;

        public DepartamentosEditModel(IDepartamentosService departamentosService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                return RedirectToPage("DepartamentosGrid");
            }
